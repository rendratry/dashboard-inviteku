 ...
 * Update name via POST /update-user and avatar via POST /update-avatar.
 */
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      >
        ...
        {avatarAlert.type && (
          <div className="mt-4">
            <Alert type={avatarAlert.type} message={avatarAlert.message} />
          </div>
        )}
      </motion.div>
      ...
      >
        ...
        <form onSubmit={handleNameSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="profile-name" className="block text-sm font-medium text-ink-muted">
              Display Name
            </label>
            <input
              id="profile-name"
      ...
      >
        ...
        <p className="text-sm text-slate-soft mb-4">
          Password changes are handled via the verification endpoint.
        </p>
